...
/***/ function(module, exports, __webpack_require__) {
	...
	var OneTimeClickLink = (function (_React$Component) {
	  _inherits(OneTimeClickLink, _React$Component);

	  function OneTimeClickLink(props) {
	    _classCallCheck(this, OneTimeClickLink);

	    _get(Object.getPrototypeOf(OneTimeClickLink.prototype), "constructor", this).call(this, props);
	    this.state = { clicked: false };
	    this.linkClicked = this.linkClicked.bind(this);
	  }

	  _createClass(OneTimeClickLink, [{
	    key: "linkClicked",
	    value: function linkClicked(event) {
	    ...
	    value: function render() {
	      if (this.state.clicked === false) {
	        return React.createElement(
	          "a",
	          { href: "#", id: "click", onClick: this.linkClicked },
	          "Click me"
	        );
	      } else {
	        return React.createElement(
	...
	var HelloWorldApp = (function (_React$Component3) {
	  _inherits(HelloWorldApp, _React$Component3);

	  function HelloWorldApp() {
	    _classCallCheck(this, HelloWorldApp);

	    _get(Object.getPrototypeOf(HelloWorldApp.prototype), "constructor", this).apply(this, arguments);
	  }
	  ...
	  _createClass(HelloWorldApp, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { id: "two-tags" },
	        React.createElement(HelloWorld, { name: "Peter" }),
	        React.createElement(OneTimeClickLink, null)
	      );
	    }
	  }]);
	...
	React.render(React.createElement(HelloWorldApp, null), document.getElementById("greeting"));
